...
| **Trạng thái ngườichơi (Player State)** | Player data (component) | Hệ thống | Level, chỉ số, quân đoàn, quest |
| **Cấu hình (Config)** | Config file | Ngườichơi | Độ khó, adaptive on/off, giới hạn hiệu năng |
...
## 3. Schema — Bóng của ngườichơi (shadow instance — player state)
...
- Nguyên tắc bảo toàn: **không bao giờ xóa dữ liệu ngườichơi** khi migrate; trường lạ được giữ trong `_legacy` để tương lai có thể dùng lại.
