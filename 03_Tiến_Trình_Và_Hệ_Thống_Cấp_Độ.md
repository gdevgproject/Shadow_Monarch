...
| Quest Hệ Thống | 15% | Daily + chuỗi chính + ẩn |
...
- Mỗi level: **+1 tự động vào cả 5 chỉ số** (đảm bảo tuyến tính tối thiểu — không ai "phế" vì build sai) **+ 5 điểm tự do**.
- **Respec:** cho phép, tốn Tinh Hoa, giới hạn 1 lần/3 ngày trong game — đủ thoải mái để thử build, đủ đắt để lựa chọn có trọng lượng.
- **Soft cap mỗi chỉ số:** hiệu quả giảm dần sau 100 điểm tự do (diminishing returns, công thức 14.3) — chống "all-in một stat" là meta duy nhất.
...
|---|---|---|
| **E** | Mặc định sau Thức Tỉnh | Gate hạng E |
| **D** | Level 10 + quest rank-up | Gate D, ô kỹ năng 2 |
| **C** | Level 20 + đánh bại boss gate C | Gate C, Instant Dungeon key tier 1 |
| **B** | Level 35 + Job Change hoàn tất | **Trỗi Dậy**, Gate B |
| **A** | Level 55 + quân đoàn ≥ 3 bóng cấp Kỵ Sĩ | Gate A, Formation nâng cao |
| **S** | Level 75 + solo boss gate A | Gate S, Vực Tháp, Monarch's Domain |
...
### 6.2. Potential (Tiềm Năng) — tăng trưởng dài hạn

Mỗi chỉ số có **Potential ẩn (D→S)** quyết định hiệu quả mỗi điểm gán vào (hệ số 0.8–1.2). Potential **tăng chậm theo cách chơi thật**: hay né đòn → AGI potential lên; hay nuôi quân đoàn → INT potential lên. 

> **Lý do thiết kế:** đây là cơ chế "bạn trở thành thứ bạn làm" — emergent identity. Nó thưởng cho lối chơi tự nhiên thay vì ép meta, và là nguồn build diversity không cần thêm chỉ số.
...
3. Quan trọng nhất: **không reset bất cứ thứ gì**. Prestige của UMBRA là *cộng thêm*, không phải *cướp đi để cho lại* — trái ngược vòng lặp bóc lột của game F2P.
