...
> **Quy tắc phím v3.0:** không hardcode một phím như hợp đồng thiết kế. Lần đầu mở game, mod phát hiện xung đột với Minecraft và các binding Fabric đã đăng ký, gán một binding trống an toàn, báo rõ và cho phép remap toàn bộ. Lớp action chỉ bật trong combat stance (có kẻ địch aggro trong tầm hoặc tự bật), không làm builder khó chịu.
...
## 11. Bổ sung v3.0 — skill expression, tốc độ và thú cưỡi
