...
| II | **Kẻ Thức Tỉnh** | 1–20 | Hệ Thống: level, 5 chỉ số tự phân bổ, daily quest, kỹ năng chủ động | Double Dungeon tutorial, gate F–D |
...
| VI | **Chúa Tể** | 100+ | Thăng Giới, Thế Giới Song Song, quyền năng Vương Giả, boss Cửu Vương | Vực Tháp, raid tự chọn, nội dung hậu truyện không reset |
...
*Gate* là hoạt động có mở đầu và kết thúc: không đóng chỉ vì hết giờ; nó chỉ đóng sau boss/mục tiêu bắt buộc, nên xác và cơ hội Trỗi Dậy không bị mất vì nhịp combat. Trong vùng chơi chỉ có tối đa hai Gate đang hoạt động. Các Gate gần người chơi ưu tiên chênh tối đa hai bậc sức mạnh hiệu dụng, nhưng Gate hiếm vượt bậc vẫn có thể xuất hiện với cảnh báo/trinh sát rõ ràng.
